...
|------|:------:|--------:|--------------:|-------:|-----------:|---------:|--------:|-------|
| A-empty_file | PASS | 104 | 209 | -50.2% | — | — | — | empty file in corpus – must round-trip with zero bytes |
| A-single_byte | PASS | 61 | 162 | -62.3% | — | — | — | single-byte file |
| A-large_file | PASS | 663 | 1,183 | -44.0% | 1.707s | 0.243s | 61.8 MB | 10 MB structured log |
| A-many_small_files | PASS | 2,488 | 10,879 | -77.1% | 0.042s | 0.043s | — | 500 small structured log files |
| A-mixed_text_binary | PASS | 700 | 838 | -16.5% | — | — | — | text + binary in same corpus |
...
| A-unique_content | PASS | 1,823 | 1,712 | 6.5% | — | — | — | 200 lines each with random payload – fallback path |
...
| B-high_cardinality | PASS | 4,313 | 3,973 | 8.6% | — | — | — | unique lines – fallback expected; no crash |
...
| C-json_ndjson | PASS | 1,610 | 1,633 | -1.4% | — | — | — | NDJSON + JSON config |
| C-mixed_formats | PASS | 314 | 401 | -21.7% | — | — | — | nginx + app log + ndjson + markdown |
| C-precompressed | PASS | 276 | 418 | -34.0% | — | — | — | gz + zip + log; binary_fallback=2 |
| C-all_binary_fallback | PASS | 5,304 | — | — | — | — | — | 5 random-binary files → all binary_fallback |
| D-perf_small | PASS | 195 | 636 | -69.3% | 0.006s | 0.001s | 0.4 MB | 10 × 5 KB structured logs |
| D-perf_medium | PASS | 448 | 11,925 | -96.2% | 0.332s | 0.044s | 10.6 MB | 20 × ~100 KB structured logs ≈ 2 MB |
| D-perf_large | PASS | 730 | 1,720 | -57.6% | 1.866s | 0.252s | 56.5 MB | 5 × 2 MB repetitive logs ≈ 10 MB |
| E-regression_structured_logs | PASS | 5,243 | 7,666 | -31.6% | — | — | — | Δ=-31.6% – within threshold |
...
| E-regression_json | PASS | 1,610 | 1,635 | -1.5% | — | — | — | Δ=-1.5% – within threshold |
| E-regression_mixed | PASS | 314 | 419 | -25.1% | — | — | — | Δ=-25.1% – within threshold |
