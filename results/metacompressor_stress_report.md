...
|------|:------:|--------:|--------------:|-------:|-----------:|---------:|--------:|-------|
| A-empty_file | PASS | 107 | 206 | -48.1% | — | — | — | empty file in corpus – must round-trip with zero bytes |
| A-single_byte | PASS | 61 | 160 | -61.9% | — | — | — | single-byte file |
| A-many_small_files | PASS | 836 | 10,891 | -92.3% | 0.100s | 0.047s | — | 500 small structured log files |
| A-mixed_text_binary | PASS | 714 | 848 | -15.8% | — | — | — | text + binary in same corpus |
| A-long_lines | PASS | 136 | 221 | -38.5% | — | — | — | 10 000-char lines |
| A-no_trailing_newline | PASS | 82 | 170 | -51.8% | — | — | — | file with no trailing newline |
| A-repetitive_content | PASS | 117 | 207 | -43.5% | — | — | — | 5 000 identical lines; ratio=0.0007; tpl_reuse=1.00 |
| A-unique_content | PASS | 1,330 | 1,696 | -21.6% | — | — | — | 200 lines each with random payload – fallback path |
| B-random_data | PASS | 65,602 | 65,720 | -0.2% | — | — | — | fully random binary – binary_fallback expected |
| B-nearly_identical_lines | PASS | 309 | 1,022 | -69.8% | — | — | — | 500 lines w/ same template; reuse_rate=1.00 |
| B-high_cardinality | PASS | 3,120 | 3,993 | -21.9% | — | — | — | unique lines – fallback expected; no crash |
...
| C-mixed_formats | PASS | 320 | 401 | -20.2% | — | — | — | nginx + app log + ndjson + markdown |
...
| D-perf_small | PASS | 202 | 544 | -62.9% | 0.048s | 0.002s | 0.4 MB | 10 × 5 KB structured logs |
| D-perf_medium | PASS | 465 | 12,127 | -96.2% | 3.395s | 0.089s | 7.1 MB | 20 × ~100 KB structured logs ≈ 2 MB |
| E-regression_structured_logs | PASS | 1,718 | 7,090 | -75.8% | — | — | — | Δ=-75.8% – within threshold |
...
| E-regression_json | PASS | 876 | 1,516 | -42.2% | — | — | — | Δ=-42.2% – within threshold |
| E-regression_mixed | PASS | 320 | 405 | -21.0% | — | — | — | Δ=-21.0% – within threshold |
