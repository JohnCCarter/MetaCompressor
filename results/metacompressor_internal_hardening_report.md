...
|---------|----:|-------------------:|---------:|-------:|-------------:|-----:|-------:|-----------:|---------:|--------:|--------|-------|
| H-50mb_structured | 52,428,800 | 2,617 | 5,024 | -47.9% | 4,877 | 178,232 | — | 8.949s | 1.235s | 301.3 MB | MC | 50 MB structured log; tpl_reuse=1.00; ratio=0.00005 |
| H-100mb_structured | 104,857,600 | 5,032 | 9,826 | -48.8% | 9,677 | 356,205 | — | 17.874s | 2.445s | 602.9 MB | MC | 100 MB structured log; tpl_reuse=1.00; ratio=0.000048 |
| H-2000_small_files | 152,679 | 6,495 | 39,148 | -83.4% | 145,326 | 54,313 | — | 0.660s | 0.091s | 6.8 MB | MC | 2 000 small files; tpl_reuse=1.00; files=2000 |
| H-mixed_app_logs | 146,392 | 8,756 | 9,783 | -10.5% | 7,679 | 13,975 | — | 0.014s | 0.003s | — | per-file-zstd | 4 app log formats; tpl_reuse=1.00; templates=9 |
| H-nginx_10k | 1,183,385 | 121,514 | 117,203 | 3.7% | 117,045 | 156,901 | — | 0.107s | 0.021s | — | per-file-zstd | 10 000 nginx lines; tpl_reuse=1.00; templates=1; low_struct_fb=0 |
| H-ndjson_50k | 5,346,556 | 167,755 | 225,618 | -25.6% | 225,197 | 436,342 | — | 1.811s | 0.079s | 61.5 MB | MC | 50k NDJSON lines; tpl_reuse=1.00; templates=3 |
| H-prose | 184,915 | 40,655 | 40,809 | -0.4% | 40,592 | 35,502 | — | — | — | — | gzip | prose text; tpl_reuse=0.00; binary_fb=1; low_struct_fb=0 |
| H-low_struct_fallback | — | — | — | — | — | — | — | — | — | — | — | low-structure fallback fires; low_struct_fb=1 |
| H-low_struct_size | — | 469 | 586 | -20.0% | 394 | — | — | — | — | — | per-file-zstd | low-struct size test; Δ=-20.0%; low_struct_fb=1 |
| H-highcard_2k | 170,690 | 43,551 | 43,646 | -0.2% | 43,460 | 45,093 | — | — | — | — | per-file-zstd | 2000 lines; recurring tpl; random vals; tpl_reuse=0.00; Δ=-0.2% |
| H-random_binary_mix | 470,304 | 99,340 | 98,810 | 0.5% | 98,485 | — | — | — | — | — | per-file-zstd | random+structured mix; binary_fb=2; tpl_reuse=1.00 |
| H-precompressed_mix | 40,177 | 304 | 460 | -33.9% | 249 | — | — | — | — | — | per-file-zstd | gz+zst+log; binary_fb=2; tpl_reuse=1.00 |
...
| H-reg_mixed_app_logs | — | 8,756 | 9,680 | -9.5% | — | — | — | — | — | — | MC | Δ=-9.5% – within threshold |
| H-reg_2000_small | — | 6,495 | 39,045 | -83.4% | — | — | — | — | — | — | MC | Δ=-83.4% – within threshold |
| H-reg_prose | — | 40,655 | 40,808 | -0.4% | — | — | — | — | — | — | MC | Δ=-0.4% – within threshold |
...
- **H-50mb_structured**: MC=2,617 vs TAR+ZSTD=5,024 (Δ=-47.9%)  50 MB structured log; tpl_reuse=1.00; ratio=0.00005
- **H-100mb_structured**: MC=5,032 vs TAR+ZSTD=9,826 (Δ=-48.8%)  100 MB structured log; tpl_reuse=1.00; ratio=0.000048
- **H-2000_small_files**: MC=6,495 vs TAR+ZSTD=39,148 (Δ=-83.4%)  2 000 small files; tpl_reuse=1.00; files=2000
- **H-mixed_app_logs**: MC=8,756 vs TAR+ZSTD=9,783 (Δ=-10.5%)  4 app log formats; tpl_reuse=1.00; templates=9
- **H-ndjson_50k**: MC=167,755 vs TAR+ZSTD=225,618 (Δ=-25.6%)  50k NDJSON lines; tpl_reuse=1.00; templates=3
- **H-low_struct_size**: MC=469 vs TAR+ZSTD=586 (Δ=-20.0%)  low-struct size test; Δ=-20.0%; low_struct_fb=1
- **H-precompressed_mix**: MC=304 vs TAR+ZSTD=460 (Δ=-33.9%)  gz+zst+log; binary_fb=2; tpl_reuse=1.00
- **H-reg_structured_50mb**: MC=2,617 vs TAR+ZSTD=5,023 (Δ=-47.9%)  Δ=-47.9% – within threshold
- **H-reg_mixed_app_logs**: MC=8,756 vs TAR+ZSTD=9,680 (Δ=-9.5%)  Δ=-9.5% – within threshold
- **H-reg_2000_small**: MC=6,495 vs TAR+ZSTD=39,045 (Δ=-83.4%)  Δ=-83.4% – within threshold
