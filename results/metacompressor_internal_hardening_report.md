...
|---------|----:|-------------------:|---------:|-------:|-------------:|-----:|-------:|-----------:|---------:|--------:|--------|-------|
| H-2000_small_files | 152,679 | 2,153 | 39,790 | -94.6% | 145,326 | 54,562 | — | 3.616s | 0.171s | 11.3 MB | MC | 2 000 small files; tpl_reuse=1.00; files=2000 |
| H-mixed_app_logs | 146,392 | 4,141 | 9,661 | -57.1% | 7,679 | 13,970 | 9,308 | 0.187s | 0.005s | — | MC | 4 app log formats; tpl_reuse=1.00; templates=7 |
| H-nginx_10k | 1,183,385 | 13,975 | 117,215 | -88.1% | 117,045 | 156,903 | 132,088 | 1.603s | 0.033s | — | MC | 10 000 nginx lines; tpl_reuse=1.00; templates=1; low_struct_fb=0 |
| H-prose | 184,915 | 40,477 | 40,806 | -0.8% | 40,592 | 35,501 | 44,313 | — | — | — | gzip | prose text; tpl_reuse=0.00; binary_fb=1; low_struct_fb=0 |
| H-low_struct_fallback | — | — | — | — | — | — | — | — | — | — | — | low-structure fallback fires; low_struct_fb=1 |
| H-low_struct_size | — | 479 | 599 | -20.0% | 394 | — | — | — | — | — | per-file-zstd | low-struct size test; Δ=-20.0%; low_struct_fb=1 |
| H-highcard_2k | 170,690 | 39,468 | 43,478 | -9.2% | 43,291 | 45,034 | — | — | — | — | MC | 2000 lines; recurring tpl; random vals; tpl_reuse=0.44; Δ=-9.2% |
| H-random_binary_mix | 470,304 | 98,832 | 98,838 | -0.0% | 98,485 | — | — | — | — | — | per-file-zstd | random+structured mix; binary_fb=2; tpl_reuse=1.00 |
| H-precompressed_mix | 40,177 | 314 | 453 | -30.7% | 249 | — | — | — | — | — | per-file-zstd | gz+zst+log; binary_fb=2; tpl_reuse=1.00 |
...
| H-reg_mixed_app_logs | — | 4,141 | 9,666 | -57.2% | — | — | — | — | — | — | MC | Δ=-57.2% – within threshold |
| H-reg_2000_small | — | 2,153 | 39,244 | -94.5% | — | — | — | — | — | — | MC | Δ=-94.5% – within threshold |
| H-reg_prose | — | 40,477 | 40,805 | -0.8% | — | — | — | — | — | — | MC | Δ=-0.8% – within threshold |
...
- **H-2000_small_files**: MC=2,153 vs TAR+ZSTD=39,790 (Δ=-94.6%)  2 000 small files; tpl_reuse=1.00; files=2000
- **H-mixed_app_logs**: MC=4,141 vs TAR+ZSTD=9,661 (Δ=-57.1%)  4 app log formats; tpl_reuse=1.00; templates=7
- **H-nginx_10k**: MC=13,975 vs TAR+ZSTD=117,215 (Δ=-88.1%)  10 000 nginx lines; tpl_reuse=1.00; templates=1; low_struct_fb=0
- **H-low_struct_size**: MC=479 vs TAR+ZSTD=599 (Δ=-20.0%)  low-struct size test; Δ=-20.0%; low_struct_fb=1
- **H-highcard_2k**: MC=39,468 vs TAR+ZSTD=43,478 (Δ=-9.2%)  2000 lines; recurring tpl; random vals; tpl_reuse=0.44; Δ=-9.2%
- **H-precompressed_mix**: MC=314 vs TAR+ZSTD=453 (Δ=-30.7%)  gz+zst+log; binary_fb=2; tpl_reuse=1.00
- **H-reg_mixed_app_logs**: MC=4,141 vs TAR+ZSTD=9,666 (Δ=-57.2%)  Δ=-57.2% – within threshold
- **H-reg_2000_small**: MC=2,153 vs TAR+ZSTD=39,244 (Δ=-94.5%)  Δ=-94.5% – within threshold
