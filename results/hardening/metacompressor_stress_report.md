...
|------|:------:|--------:|--------------:|-------:|-----------:|---------:|--------:|-------|
| A-empty_file | PASS | 107 | 187 | -42.8% | — | — | — | empty file in corpus – must round-trip with zero bytes |
| A-single_byte | PASS | 61 | 152 | -59.9% | — | — | — | single-byte file |
| A-many_small_files | PASS | 836 | 9,894 | -91.6% | 0.168s | 0.358s | — | 500 small structured log files |
| A-mixed_text_binary | PASS | 714 | 821 | -13.0% | — | — | — | text + binary in same corpus |
...
| A-unique_content | PASS | 1,327 | 1,684 | -21.2% | — | — | — | 200 lines each with random payload – fallback path |
| B-random_data | PASS | 65,602 | 65,728 | -0.2% | — | — | — | fully random binary – binary_fallback expected |
| B-nearly_identical_lines | PASS | 309 | 1,003 | -69.2% | — | — | — | 500 lines w/ same template; reuse_rate=1.00 |
| B-high_cardinality | PASS | 3,123 | 3,971 | -21.4% | — | — | — | unique lines – fallback expected; no crash |
...
| C-nginx_logs | PASS | 3,467 | 11,931 | -70.9% | — | — | — | 1 000 nginx lines; tpl_reuse=1.00 |
| C-json_ndjson | PASS | 876 | 1,503 | -41.7% | — | — | — | NDJSON + JSON config |
| C-mixed_formats | PASS | 320 | 398 | -19.6% | — | — | — | nginx + app log + ndjson + markdown |
| C-precompressed | PASS | 294 | 422 | -30.3% | — | — | — | gz + zip + log; binary_fallback=2 |
| C-all_binary_fallback | PASS | 5,302 | — | — | — | — | — | 5 random-binary files → all binary_fallback |
| D-perf_small | PASS | 202 | 322 | -37.3% | 0.040s | 0.011s | 0.4 MB | 10 × 5 KB structured logs |
| D-perf_medium | PASS | 465 | 12,642 | -96.3% | 3.664s | 0.068s | 7.1 MB | 20 × ~100 KB structured logs ≈ 2 MB |
| E-regression_structured_logs | PASS | 1,718 | 7,035 | -75.6% | — | — | — | Δ=-75.6% – within threshold |
| E-regression_nginx | PASS | 3,467 | 11,932 | -70.9% | — | — | — | Δ=-70.9% – within threshold |
| E-regression_random | PASS | 65,602 | 65,728 | -0.2% | — | — | — | Δ=-0.2% – within threshold |
| E-regression_json | PASS | 876 | 1,505 | -41.8% | — | — | — | Δ=-41.8% – within threshold |
| E-regression_mixed | PASS | 320 | 413 | -22.5% | — | — | — | Δ=-22.5% – within threshold |
