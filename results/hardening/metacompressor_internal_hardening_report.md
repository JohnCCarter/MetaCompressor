...
|---------|----:|-------------------:|---------:|-------:|-------------:|-----:|-------:|-----------:|---------:|--------:|--------|-------|
| H-2000_small_files | 152,679 | 2,151 | 34,554 | -93.8% | 145,326 | 52,083 | — | 2.242s | 1.295s | 13.7 MB | MC | 2 000 small files; tpl_reuse=1.00; files=2000 |
| H-mixed_app_logs | 146,392 | 4,795 | 9,687 | -50.5% | 7,711 | 13,892 | — | 0.055s | 0.007s | — | MC | 4 app log formats; tpl_reuse=1.00; templates=7 |
| H-nginx_10k | 1,183,385 | 26,509 | 116,096 | -77.2% | 115,972 | 156,889 | — | 0.342s | 0.031s | — | MC | 10 000 nginx lines; tpl_reuse=1.00; templates=1; low_struct_fb=0 |
| H-prose | 184,915 | 42,289 | 40,776 | 3.7% | 40,581 | 35,480 | — | — | — | — | gzip | prose text; tpl_reuse=0.00; binary_fb=1; low_struct_fb=0 |
| H-low_struct_fallback | — | — | — | — | — | — | — | — | — | — | — | low-structure fallback fires; low_struct_fb=1 |
| H-low_struct_size | — | 520 | 557 | -6.6% | 394 | — | — | — | — | — | per-file-zstd | low-struct size test; Δ=-6.6%; low_struct_fb=1 |
| H-highcard_2k | 170,690 | 42,769 | 43,416 | -1.5% | 43,259 | 45,058 | — | — | — | — | MC | 2000 lines; recurring tpl; random vals; tpl_reuse=0.43; Δ=-1.5% |
| H-random_binary_mix | 470,304 | 98,856 | 98,838 | 0.0% | 98,485 | — | — | — | — | — | per-file-zstd | random+structured mix; binary_fb=2; tpl_reuse=1.00 |
...
| H-reg_2000_small | — | 2,151 | 34,555 | -93.8% | — | — | — | — | — | — | MC | Δ=-93.8% – within threshold |
| H-reg_prose | — | 42,289 | 40,781 | 3.7% | — | — | — | — | — | — | TAR+ZSTD | Δ=3.7% – within threshold |
...
- **H-2000_small_files**: MC=2,151 vs TAR+ZSTD=34,554 (Δ=-93.8%)  2 000 small files; tpl_reuse=1.00; files=2000
- **H-mixed_app_logs**: MC=4,795 vs TAR+ZSTD=9,687 (Δ=-50.5%)  4 app log formats; tpl_reuse=1.00; templates=7
- **H-nginx_10k**: MC=26,509 vs TAR+ZSTD=116,096 (Δ=-77.2%)  10 000 nginx lines; tpl_reuse=1.00; templates=1; low_struct_fb=0
- **H-low_struct_size**: MC=520 vs TAR+ZSTD=557 (Δ=-6.6%)  low-struct size test; Δ=-6.6%; low_struct_fb=1
...
- **H-reg_2000_small**: MC=2,151 vs TAR+ZSTD=34,555 (Δ=-93.8%)  Δ=-93.8% – within threshold
