...
- `benchmarks/differential_partial_reuse_simulation.py` (reporting alignment only)
...
- Optional new focused test: `metacompressor/tests/test_differential_partial_reuse_gate.py`
- `docs/differential-partial-reuse-design.md` (if clarifications are needed)
