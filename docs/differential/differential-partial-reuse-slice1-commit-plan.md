...
- Optional new focused test: `metacompressor/tests/differential/test_differential_partial_reuse_gate.py` (schema section only)
...
- `python -m pytest metacompressor/tests/differential/test_differential_persistence.py -v`
- `python -m pytest metacompressor/tests/differential/test_differential_partial_reuse_gate.py -k schema -v` (if created)
...
- `metacompressor/tests/differential/test_differential_partial_reuse_gate.py` (orchestration/gate cases)
...
- `python -m pytest metacompressor/tests/differential/test_differential_orchestrator.py -v`
- `python -m pytest metacompressor/tests/differential/test_differential_partial_reuse_gate.py -k "flag or merge or fallback" -v`
...
- `benchmarks/differential/differential_partial_reuse_simulation.py` (alignment only)
- `metacompressor/tests/differential/test_differential_orchestrator.py`
...
- `python -m pytest metacompressor/tests/differential/test_differential_parity_gate_harness.py -v`
- `python -m pytest metacompressor/tests/differential/test_differential_partial_reuse_gate.py -k "parity or strategy or noisy or report" -v`
- `python -m pytest metacompressor/tests/differential/test_differential_orchestrator.py -v`
- `python -m pytest metacompressor/tests -q`
- `ruff check metacompressor benchmarks`
- `black --check metacompressor benchmarks`
- `python benchmarks/differential/differential_parity_gate.py --run-count 20`
- `python benchmarks/differential/differential_partial_reuse_simulation.py --run-count 20`
