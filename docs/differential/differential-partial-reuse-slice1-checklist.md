...
- `metacompressor/tests/differential/test_differential_partial_reuse_gate.py` (new focused tests if needed)
- `benchmarks/differential/differential_parity_gate.py` (report alignment only)
- `benchmarks/differential/differential_partial_reuse_simulation.py` (report alignment only)
...
- `python -m pytest metacompressor/tests/differential/test_differential_partial_reuse_gate.py -v` (if created)
