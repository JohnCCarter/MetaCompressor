...
from metacompressor.container import serialise
from metacompressor.delta import delta_encoded_size, find_similar_chunk
from metacompressor.mc1_types import MC1Container
...
def build_mc1_container(
    ...
    *,
    ...
    """Run chunking, dedupe, and delta selection; return the in-memory container.

    :func:`compress` is ``serialise(build_mc1_container(...))``.
    """
