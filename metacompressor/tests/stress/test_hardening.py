...
``results/hardening/metacompressor_internal_hardening_report.md`` after all tests finish.
"""
...
class TestHardeningRegressionGate:
    ...
    def test_regression_random_binary(self, tmp_path):
        ...
        from metacompressor.tests.stress.test_stress_suite import gen_random_data
