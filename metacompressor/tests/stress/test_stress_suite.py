...
Run with::
    ...
    python -m pytest metacompressor/tests/stress/test_stress_suite.py -v

A session-scoped fixture writes a Markdown report to
``results/hardening/metacompressor_stress_report.md`` after all tests finish.
...
_RESULTS_DIR = (
    ...
    else _REPO_ROOT / "results" / "hardening"
)
...
def _emit_report() -> None:
    """Write markdown report to results/hardening/metacompressor_stress_report.md."""
