...
def test_quick_differential_report_changed_dataset(tmp_path):
    ...
    assert changed["decision_report"]["analysis_skip_used"] is True
    assert (
        changed["decision_report"]["forced_rescan_reason"] == "changed_chunks_present"
    )
...
def test_quick_differential_invalid_receipt_disables_skip(tmp_path):
    ...
    assert (
        out["decision_report"]["forced_rescan_reason"] == "invalid_or_missing_receipt"
    )
...
def test_quick_differential_low_confidence_disables_skip(tmp_path):
    ...
    assert out["decision_report"]["analysis_skip_used"] is False
    assert out["decision_report"]["forced_rescan_reason"] == "low_confidence"
