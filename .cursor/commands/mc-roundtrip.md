...
2. Run targeted pytest from repo root, e.g.:
   ...
   - `python -m pytest metacompressor/tests/test_compressor.py -q`
   - Add `metacompressor/tests/test_delta.py` or other `test_*.py` files under `metacompressor/tests/` if edits warrant it.
